...
\textbf{Quizzes:}  There will be four short quizzes throughout the semester, which will be taken on four Fridays throughout the term. Each quiz is a short assessment of your knowledge of one module / topic. Quizzes are meant to ensure you clearly demonstrate competence regarding the individual topics for that module.
...
\begin{itemize}
    \item \textbf{Homework (30\%)}: There will be six programming challenges which account in total for 30 percent of the final grade.
    \item \textbf{Quizzes (40\%)}: There will be four in-class quizzes which account for 40 percent of the final grade.
